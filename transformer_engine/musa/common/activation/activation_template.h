...
#include "../common.h"
#include "../util/cast_gated_kernels.muh"
...
void act_fn(const NVTETensor input, NVTETensor output, musaStream_t stream) {
...
void gated_act_fn(const NVTETensor input, NVTETensor output, musaStream_t stream) {
  using namespace detail;
