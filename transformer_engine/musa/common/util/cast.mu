...
#include "../utils.muh"
#include "cast_kernels.muh"
#include "dequantize_kernels.muh"
#include "math.h"
// #include "ptx.cuh"
#include "transformer_engine/activation.h"
#include "transformer_engine/transpose.h"

void nvte_quantize(const NVTETensor input, NVTETensor output, musaStream_t stream) {
...
void nvte_dequantize(const NVTETensor input, NVTETensor output, musaStream_t stream) {
