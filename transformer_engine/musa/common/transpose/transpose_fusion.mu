...
void fp8_transpose_dbias(const Tensor &input, Tensor *transposed_output, Tensor *dbias,
                         Tensor *workspace, musaStream_t stream) {
  ...
  TRANSFORMER_ENGINE_TYPE_SWITCH_INPUT(
      ...
      TRANSFORMER_ENGINE_TYPE_SWITCH_FP8ONLY(
          ...
          if (full_tile) {
            musaFuncSetAttribute(transpose_dbias_kernel<nvec_in, nvec_out, Param>,
            ...
            musaFuncSetAttribute(transpose_dbias_kernel_notaligned<nvec_in, nvec_out, Param>,
                                 musaFuncAttributePreferredSharedMemoryCarveout, 100);
...
void nvte_fp8_transpose_dbias(const NVTETensor input, NVTETensor transposed_output,
                              NVTETensor dbias, NVTETensor workspace, musaStream_t stream) {
