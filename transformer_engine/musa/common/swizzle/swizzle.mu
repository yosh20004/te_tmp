...
void swizzle_scaling_factors(const Tensor* input, Tensor* output, musaStream_t stream) {
  ...
  if (scaling_mode == NVTE_MXFP8_1D_SCALING) {
    ...
    if (input->has_data()) {
      ...
      switch (vec_load_size) {
        case 4:
          musaFuncSetAttribute(swizzle_row_scaling_kernel<int4, SF_TILE_DIM_M, SF_TILE_DIM_K>,
                               musaFuncAttributeMaxDynamicSharedMemorySize, slm_size);
          ...
          break;
        case 2:
          musaFuncSetAttribute(swizzle_row_scaling_kernel<int2, SF_TILE_DIM_M, SF_TILE_DIM_K>,
                               musaFuncAttributeMaxDynamicSharedMemorySize, slm_size);
          ...
          break;
        case 1:
          musaFuncSetAttribute(swizzle_row_scaling_kernel<int, SF_TILE_DIM_M, SF_TILE_DIM_K>,
                               musaFuncAttributeMaxDynamicSharedMemorySize, slm_size);
    ...
    if (input->has_columnwise_data()) {
      ...
      switch (vec_load_size) {
        case 4:
          musaFuncSetAttribute(swizzle_col_scaling_kernel<int4, SF_TILE_DIM_M, SF_TILE_DIM_K>,
                               musaFuncAttributeMaxDynamicSharedMemorySize, slm_size);
          ...
          break;
        case 2:
          musaFuncSetAttribute(swizzle_col_scaling_kernel<int2, SF_TILE_DIM_M, SF_TILE_DIM_K>,
                               musaFuncAttributeMaxDynamicSharedMemorySize, slm_size);
          ...
          break;
        case 1:
          musaFuncSetAttribute(swizzle_col_scaling_kernel<int, SF_TILE_DIM_M, SF_TILE_DIM_K>,
                               musaFuncAttributeMaxDynamicSharedMemorySize, slm_size);
...
*/
void nvte_swizzle_scaling_factors(const NVTETensor input, NVTETensor output, musaStream_t stream) {
