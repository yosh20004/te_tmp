...
void mha_fill(const transformer_engine::TensorWrapper &self, const at::Tensor &start_index) {
  ...
  const int num_mp = at::musa::getCurrentDeviceProperties()->multiProcessorCount;
  ...
  AT_DISPATCH_ALL_TYPES_AND_COMPLEX_AND2(
      at::ScalarType::Half, at::ScalarType::BFloat16, scalar_type, "mha_fill", [&]() {
        mha_fill_kernel<<<dim_grid, dim_block, 0, at::musa::getCurrentMUSAStream()>>>(
...
// extract seed and offset from PhiloxMusaState
__global__ void unpack(at::PhiloxMusaState arg, int64_t *rng_state_ptr) {
  if (arg.captured_) {
...
// extract PhiloxMusaState from CUDA random number generator
at::PhiloxMusaState init_philox_state(at::MUSAGeneratorImpl *gen, size_t elts_per_thread) {
  at::PhiloxMusaState philox_args;
  std::lock_guard<std::mutex> lock(gen->mutex_);
  philox_args = gen->philox_musa_state(elts_per_thread);
  return philox_args;
}
...
std::vector<py::object> fused_attn_fwd(
  ...
  auto options = torch::TensorOptions()
      .dtype(GetATenDType(qkv_type))
      .device(c10::kPrivateUse1, c10::musa::current_device());
  ...
  if (qkv_type == DType::kFloat8E4M3 || qkv_type == DType::kFloat8E5M2) {
    ...
    if (set_zero && ((h * d) % block_size == 0) &&
      ...
      te_O.zero_(at::musa::getCurrentMUSAStream());
    }
  ...
  auto gen = at::get_generator_or_default<at::MUSAGeneratorImpl>(
      rng_gen, at::musa::detail::getDefaultMUSAGenerator());
  at::PhiloxMusaState philox_args = init_philox_state(gen, rng_elts_per_thread);
  auto rng_state = torch::empty({2}, options.dtype(torch::kInt64));
  unpack<<<1, 1, 0, at::musa::getCurrentMUSAStream()>>>(
...
at::Tensor fa_prepare_fwd(at::Tensor qkvi) {
  ...
  at::Tensor qkv = at::empty(
      shape, qkvi.options().device(c10::kPrivateUse1, c10::musa::current_device()));
  ...
  if (qkvi.scalar_type() == at::ScalarType::Half) {
    ...
    flash_attention::prepare_kernel_fwd<dtype>
        <<<grid, threads, 0, at::musa::getCurrentMUSAStream()>>>(
...
at::Tensor fa_prepare_bwd(at::Tensor q, at::Tensor k, at::Tensor v) {
  ...
  at::Tensor qkv = at::empty(
      shape, q.options().device(c10::kPrivateUse1, c10::musa::current_device()));
...
at::Tensor thd_read_half_tensor(const at::Tensor &tensor, const at::Tensor &cu_seqlens,
  ...
  shape[seq_dim] /= 2;
  at::Tensor half = at::empty(
      shape, tensor.options().device(c10::kPrivateUse1, c10::musa::current_device()));
...
at::Tensor thd_read_second_half_lse(const at::Tensor &lse, const at::Tensor &cu_seqlens,
  ...
  at::Tensor half_lse = at::zeros(
      shape, lse.options().device(c10::kPrivateUse1, c10::musa::current_device()));
...
at::Tensor thd_get_partitioned_indices(const at::Tensor &cu_seqlens, int total_tokens,
  ...
  at::Tensor output = at::empty(shape,
      c10::TensorOptions()
