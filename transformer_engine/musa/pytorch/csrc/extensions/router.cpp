...
std::tuple<at::Tensor, at::Tensor, at::Tensor> fused_topk_with_score_function_fwd(
  ...
  at::Tensor probs =
      at::empty({num_tokens, num_experts}, at::dtype(logits.scalar_type()).device(at::musa::kMUSA));
  at::Tensor routing_map =
      at::empty({num_tokens, num_experts}, at::dtype(at::kBool).device(at::musa::kMUSA));
...
at::Tensor fused_topk_with_score_function_bwd(int num_tokens, int num_experts,
  ...
  at::Tensor grad_logits = at::empty(
      {num_tokens, num_experts}, at::dtype(intermediate_output.scalar_type()).device(c10::DeviceType::PrivateUse1));
  ...
  nvte_fused_topk_with_score_function_backward(
      ...
      grad_logits_cu.data(), at::musa::getCurrentMUSAStream());
...
std::tuple<at::Tensor, at::Tensor, at::Tensor> fused_score_for_moe_aux_loss_fwd(
  ...
  // Construct the output tensor
  at::Tensor scores =
      at::empty({num_tokens, num_experts}, at::dtype(logits.scalar_type()).device(c10::DeviceType::PrivateUse1));
  at::Tensor routing_map =
      at::empty({num_tokens, num_experts}, at::dtype(at::kBool).device(c10::DeviceType::PrivateUse1));
  at::Tensor intermediate_output =
      at::empty({num_tokens, num_experts}, at::dtype(logits.scalar_type()).device(c10::DeviceType::PrivateUse1));
...
at::Tensor fused_score_for_moe_aux_loss_bwd(int num_tokens, int num_experts,
  ...
  nvte_fused_score_for_moe_aux_loss_backward(
      ...
      score_function_value, grad_logits_cu.data(), at::musa::getCurrentMUSAStream());
...
at::Tensor fused_moe_aux_loss_bwd(at::Tensor Const_buf, at::Tensor tokens_per_expert, int num_rows,
  ...
  at::Tensor grad_probs =
      at::empty({num_rows, num_cols}, at::dtype(grad_aux_loss.scalar_type()).device(c10::DeviceType::PrivateUse1));
