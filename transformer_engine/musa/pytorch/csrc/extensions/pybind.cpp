...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("fused_topk_with_score_function_fwd",
        &fused_topk_with_score_function_fwd, py::arg("logits"),
  ...
  m.def("fused_topk_with_score_function_bwd",
        &fused_topk_with_score_function_bwd, py::arg("num_tokens"),
  ...
  m.def("fused_moe_aux_loss_bwd", &fused_moe_aux_loss_bwd,
